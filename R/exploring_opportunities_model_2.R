#' @export
exploring_opportunities_model_2 <- function(diagonal, exploration_type, deterrence_type) {
    ...
    probability <- function(object, data) {
      purrr::map(
        ...
        \(data) {
          ...
          ExploringOpportunitiesModel_2_probability(object = object,
                                                    data = data,
  ...
  ExploringOpportunitiesModel_2(diagonal = diagonal,
                                probability = probability,
                                upper_probability = upper_probability)
}

#' @include mobility_model_2.R
ExploringOpportunitiesModel_2 <- S7::new_class(
  "ExploringOpportunitiesModel_2",
...
ExploringOpportunitiesModel_2_probability <- function(object,
                                                      data,
