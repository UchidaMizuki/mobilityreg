#' @export
intervening_opportunities_model_2 <- function(diagonal, deterrence_type) {
  ...
  InterveningOpportunitiesModel_2(diagonal = diagonal,
                                  probability = probability,
                                  upper_probability = upper_probability)
}

#' @include mobility_model_2.R
InterveningOpportunitiesModel_2 <- S7::new_class(
  "InterveningOpportunitiesModel_2",
